"""Alembic environment. Runs migrations against a sync psycopg URL derived from app settings."""
...
sync_url = get_settings().database_url.replace("+asyncpg", "").replace("+psycopg", "+psycopg")
